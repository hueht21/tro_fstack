...
@Component
public class GoogleDriveServiceImplLandLord implements GoogleDriveServiceLandLord {
  ...
  @Override
  public FileResponseLandLord uploadFile(MultipartFile file) throws IOException {
...
//        gDriveFile.setParents(Collections.singletonList(folderId));
    ...
    // Trả về
    FileResponseLandLord fileResponse = new FileResponseLandLord();
  ...
  @Override
  public List<FileResponseLandLord> getAllFile() throws IOException {
    Drive drive = this.getDrive();
    List<FileResponseLandLord> responseList = new ArrayList<>();
